...
<Placeholder ref="6.3"
  brief="Copie d'écran de l'aperçu PrusaSlicer avec le curseur vertical positionné sur la toute première couche : on ne voit que le contact avec le plateau, la jupe et les périmètres de base. Bien montrer le curseur lui-même sur le côté droit de la fenêtre."
  ratio="4/3" />
